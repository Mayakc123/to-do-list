...
class UIManager {
  ...
  handleFilterTodos(status) {
    const filteredTodos = this.todoManager.filterTodos(status    this.displayTodos(filteredTodos);
  }
  ...
  showAlertMessage(message, type) {
    ...
    this.alertMessage.classList.add("show"); // Add this line to show the alert message
    setTimeout(() => {
